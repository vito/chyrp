<?php
	...
	class AdminController {
		...
		public function change_theme() {
			global $user;
			if (!$user->can('change_settings') or empty($_GET['theme'])) return;
			$config = Config::current();
