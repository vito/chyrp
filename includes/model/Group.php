<?php
	...
	class Group extends Model {
		...
		public function edit_link($text = null, $before = null, $after = null){
			...
			echo $before.'<a href="'.$config->file_url.'/admin/?action=edit_group&amp;id='.$this->id.'" title="Edit" class="group_edit_link edit_link" id="group_edit_'.$this->id.'">'.$text.'</a>'.$after;
		}
		...
		public function delete_link($text = null, $before = null, $after = null){
			...
			$config = Config::current();
			echo $before.'<a href="'.$config->file_url.'/admin/?action=delete_group&amp;id='.$this->id.'" title="Delete" class="group_delete_link delete_link" id="group_delete_'.$this->id.'">'.$text.'</a>'.$after;
		}
	}
