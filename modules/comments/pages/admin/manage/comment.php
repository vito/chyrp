...
?>
					<div class="box">
						<h1>
							<span class="right">
								<?php if ($user->can("edit_comment")) echo $comment->edit_link($comment->id, '<img src="icons/edit.png" /> '.__("edit")); ?>
								<?php if ($user->can("delete_comment")) echo $comment->delete_link($comment->id, '<img src="icons/delete.png" /> '.__("delete")); ?>
