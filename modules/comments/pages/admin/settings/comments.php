			...
			<form class="settings" action="index.php?action=settings&amp;sub=comments" method="post">
				<p>
					<label for="akismet_api_key"><?php echo __("Akismet API Key", "comments"); ?><br /><span class="sub"> <?php echo __("(recommended)"); ?></span></label>
					<input class="text" type="text" name="akismet_api_key" value="<?php echo fix($config->akismet_api_key, "html"); ?>" id="akismet_api_key" /><br />
