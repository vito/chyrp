			...
			<form class="settings" action="index.php?action=settings&amp;sub=aggregation" method="post">
				<a href="javascript:void(0)" class="button positive" onclick="newFeed(); return false;"><img src="<?php echo $config->file_url; ?>/admin/icons/add.png" alt="add" /> Add RSS Feed</a>
				<br />
